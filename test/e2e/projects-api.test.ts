...
interface ProjectResponse { success: boolean; project: Project }
interface ProjectListResponse { success: boolean; projects: Project[]; total: number }
interface ErrorResponse { error: string; message: string; status: number }
  ...
  describe('GET /api/projects', () => {
    ...
    it('should support pagination with limit and offset', async () => {
      statement.all.mockResolvedValueOnce({
        results: [{ id: 'proj2', description: 'Project 2', created_at: 2, last_used: null }],
      });
