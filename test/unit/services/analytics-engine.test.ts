...
describe('AnalyticsEngineService', () => {
  ...
  it('should throw error for invalid data', () => {
    ...
    expect(() =>
      service.writeDataPoint(mockEnv, 'CLAUDE_CODE_ANALYTICS', invalidAdapter, {
        invalid: 'data',
      })
  ...
  it('should throw error for missing dataset binding', () => {
    ...
    expect(() =>
      service.writeDataPoint(emptyEnv, 'CLAUDE_CODE_ANALYTICS', mockAdapter, {
        test: 'value',
      })
  ...
  it('should validate before transforming', () => {
    ...
    service.writeDataPoint(mockEnv, 'CLAUDE_CODE_ANALYTICS', orderedAdapter, {
      test: 'value',
    });
